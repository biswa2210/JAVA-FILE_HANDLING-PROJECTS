...
/*------------------------------------------------| OPERATION ----> 2 |------------------------------------------------*/
    public void show(){
        ...
        if(carNos.length>0){
        System.out.println("<---------------------------------------------------------->");
        System.out.println("Total "+carNos.length+" cars have been rented");
        System.out.println("<---------------------------------------------------------->");
        for(int i=0;i< carNos.length;i++){
            ...
            System.out.println("DATE OF RENT       => "+date[i]);
            System.out.println("TIME FOR RENT      => "+time[i]);
            System.out.println("<---------------------------------------------------------->");
        }}
        else{
...
public void search(){
    ...
    for(int i=0;i< carNos.length;i++){
        ...
        System.out.println("DATE OF RENT       => "+date[i]);
        System.out.println("TIME FOR RENT      => "+time[i]+" HOURS");
        System.out.println("<---------------------------------------------------------->");
        flag=1;
        }
    ...
    public void delete(){
        ...
        if(flag==1){
            ...
            System.out.println("UPDATED..!!..THIS CAR ALLOCATION FREE...!!!");
    }
    catch(Exception e){
            System.out.println(e.getMessage());
        }
